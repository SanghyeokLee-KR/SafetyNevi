...
export function setupBoardLogic() {
    ...
    if (imgModal) {
        imgModal.onclick = (e) => { if (e.target === imgModal || e.target.classList.contains('image-view-close'))
