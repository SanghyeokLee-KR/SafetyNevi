...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 버튼 이벤트 리스너
    document.getElementById('btn-step1-next')?.addEventListener('click', () => moveStep(1, 2, "계정 정보를 입력해주세요"));
    document.getElementById('btn-step2-prev')?.addEventListener('click', () => moveStep(2, 1, "서비스 이용 약관에 동의해주세요"));
    document.getElementById('btn-step3-prev')?.addEventListener('click', () => moveStep(3, 2, "계정 정보를 입력해주세요"));
